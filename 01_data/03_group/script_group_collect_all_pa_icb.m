% For saving TODO
mkdir('./../12_group_gam_pa_icb');
mkdir('./../12_group_gam_pa_icb/data_train');
mkdir('./../12_group_gam_pa_icb/data_test');
opts.save_train_dir = './../12_group_gam_pa_icb/data_train/';
opts.save_test_dir  = './../12_group_gam_pa_icb/data_test/';

% For input data TODO
opts.train_dir  =  '../12_split_gam_pa_icb/data_train/';
opts.test_dir   =  '../12_split_gam_pa_icb/data_test/';
...
%for nClass=3:3
	...
	mkdir(save_group_dir);
	    ...
	    file_copy = [data_dir, class_name,'/',file_name_list{file_list_rand(nCpFile)}];
            ...
            file_name_des = [new_file_name,'.npy'];
