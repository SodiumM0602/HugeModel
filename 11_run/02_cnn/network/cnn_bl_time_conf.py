...
import numpy as np
import os
from cnn_bl_time_para  import *

#======================================================================================================#

class cnn_bl_time_conf(object):

    def __init__(self, input_layer_val, mode):

        self.cnn_para        = cnn_bl_time_para()
        self.input_layer_val = input_layer_val
        self.mode            = mode
        
        ### ======== LAYER 01
        with tf.device('/gpu:0'), tf.variable_scope("cnn_time_conv01")as scope:
        ...
        ### ======== LAYER 02
        with tf.device('/gpu:0'), tf.variable_scope("cnn_time_conv02")as scope:
        ...
        ### ======== LAYER 03
        with tf.device('/gpu:0'), tf.variable_scope("cnn_time_conv03")as scope:
        ...
        ### ======== LAYER 04
        with tf.device('/gpu:0'), tf.variable_scope("cnn_time_conv04")as scope:
